...
const Signin = () => {
  ...
  return (
    <div className="w-screen h-screen bg-[#cbd5e1] flex justify-center items-center relative">
      ...
      <div className="bg-white rounded-md w-[80vw] h-[60vh] md:h-[70vh] md:w-[60vw] shadow-gray shadow-lg shadow-gray-800/70 px-[3vw] py-[2vh] flex flex-col justify-between ">
